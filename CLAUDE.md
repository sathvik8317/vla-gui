...
This is a personal project to build depth in agentic systems, computer vision, and fine-tuning, not a shipped product. Reproducibility and documented reasoning matter as much as the agent working. See `PRD.md` for the full spec and `tasks.md` for the build breakdown.
